...
| --- | --- | --- | --- | --- |
| **Imgur crash bisect** — _diagnostic, round 4_ | Trail: second half → upload block → request half (B1a) crashes. Four revisions of one request, each adding one thing: **B1a-1** bare POST · **B1a-2** + text Form body · **B1a-3** + image as a File field (the suspect) · **B1a-4** + auth headers. **Open in order; tell me the first that crashes.** Only open them; none upload. | Download [1](https://raw.githubusercontent.com/misteramazingyt/shortcuts/main/signed/Imgur%20B1a-1.shortcut) · [2](https://raw.githubusercontent.com/misteramazingyt/shortcuts/main/signed/Imgur%20B1a-2.shortcut) · [3](https://raw.githubusercontent.com/misteramazingyt/shortcuts/main/signed/Imgur%20B1a-3.shortcut) · [4](https://raw.githubusercontent.com/misteramazingyt/shortcuts/main/signed/Imgur%20B1a-4.shortcut) | [Read](shortcuts/_imgur-ladder/) | **2026-09-03 01:29 UTC** · [history](https://github.com/misteramazingyt/shortcuts/commits/main/shortcuts/_imgur-ladder) |

...
| --- | --- | --- | --- | --- |
| **Imgur crash bisect** — _diagnostic, round 3_ | Trail: second half crashed → upload block crashed. Now the upload block is cut in two. **B1a** is the request (the Form/File Get-Contents-of-URL — prime suspect); **B1b** is the parse (dictionary lookups, alert). **Open both, tell me which crashes.** Only open them; neither uploads. | Download [B1a](https://raw.githubusercontent.com/misteramazingyt/shortcuts/main/signed/Imgur%20B1a.shortcut) · [B1b](https://raw.githubusercontent.com/misteramazingyt/shortcuts/main/signed/Imgur%20B1b.shortcut) | [Read](shortcuts/_imgur-ladder/) | **2026-09-03 01:25 UTC** · [history](https://github.com/misteramazingyt/shortcuts/commits/main/shortcuts/_imgur-ladder) |

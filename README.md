...
| **Upload to Imgur** | Uploads an image to Imgur anonymously (API v3, `POST /3/upload`) and offers the link on the clipboard or a QR code of it saved to Photos. Needs a free Imgur client ID pasted in. | [Download](https://raw.githubusercontent.com/misteramazingyt/shortcuts/main/signed/Upload%20to%20Imgur.shortcut) | [Read](shortcuts/imgur-upload/) |

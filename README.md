...
| --- | --- | --- | --- | --- |
| **Imgur crash bisect** — _fix found; verifying_ | The bisect landed on the culprit: the image sent as a Form **File field** was missing an outer `WFTokenAttachmentParameterState` wrapper, which crashed the app on open. Builder is fixed from ground truth. This is a one-request test of the corrected File field. **Open it — if it opens, the real Upload to Imgur v2 above is fixed too.** | Download [File Fixed](https://raw.githubusercontent.com/misteramazingyt/shortcuts/main/signed/Imgur%20File%20Fixed.shortcut) | [Read](shortcuts/_imgur-ladder/) | **2026-09-03 01:35 UTC** · [history](https://github.com/misteramazingyt/shortcuts/commits/main/shortcuts/_imgur-ladder) |

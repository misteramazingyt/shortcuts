...
| --- | --- | --- | --- | --- |
| **Imgur crash bisect** — _diagnostic_ | The real Upload to Imgur action list cut in two: **A** is the first half (pick image, convert), **B** is the second half (upload, menu, QR). A then B is byte-for-byte the whole shortcut; each half opens on its own. **Open both, tell me which crashes** — I cut that half in two and repeat. Only open them; neither uploads. | Download [A](https://raw.githubusercontent.com/misteramazingyt/shortcuts/main/signed/Imgur%20A.shortcut) · [B](https://raw.githubusercontent.com/misteramazingyt/shortcuts/main/signed/Imgur%20B.shortcut) | [Read](shortcuts/_imgur-ladder/) | **2026-09-03 01:18 UTC** · [history](https://github.com/misteramazingyt/shortcuts/commits/main/shortcuts/_imgur-ladder) |

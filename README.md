...
| --- | --- | --- | --- | --- |
| **Imgur crash ladder** — _diagnostic_ | Seven shortcuts, each one construct bigger than the last, starting from the skeleton of a shortcut that is known to open. Open them in order on the phone; **the first rung that crashes names the construct** that kills the Shortcuts app in Upload to Imgur. Rung 7 is Upload to Imgur v2 itself under a current-format top-level. Only open them — don't run rung 5+ to the end. | [Rungs 1–7](shortcuts/_imgur-ladder/#imgur-crash-ladder) | [Read](shortcuts/_imgur-ladder/) | **2026-09-03 01:09 UTC** · [history](https://github.com/misteramazingyt/shortcuts/commits/main/shortcuts/_imgur-ladder) |

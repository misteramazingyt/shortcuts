...
Run from anywhere:  python3 shortcuts/clipboard-to-txt/build.py
"""
...
if __name__ == "__main__":
    write_shortcut(os.path.join(HERE, "Clipboard to TXT.shortcut"), build_in_memory())
    write_shortcut(
        os.path.join(HERE, "Clipboard to TXT (Save to Files).shortcut"),
        build_save_to_files(),
    )
